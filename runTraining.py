...
def create_config():
    ...
    parser.add_argument('--rl_manager_lstm', type=int, default=256, help='rl manager dimensions')
    ...
    parser.add_argument('--lr', type=float, default=0.0007, help='lr (if scheduler is constant)')
